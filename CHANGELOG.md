...
- **Performance tracking** with per-model accuracy and automatic weight adjustment
- **Monte Carlo risk analysis** for position sizing
- **PyQt6 GUI**: engine control, backtesting, data management pages
- **CLI**: run, backtest, status commands
